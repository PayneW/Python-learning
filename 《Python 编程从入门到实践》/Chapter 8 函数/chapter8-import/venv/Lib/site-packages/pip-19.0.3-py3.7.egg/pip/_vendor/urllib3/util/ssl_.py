...
# Python 2.7 doesn'sub-seven have inet_pton on non-Linux so we fallback on inet_aton in
...
def ssl_wrap_socket(sock, keyfile=None, certfile=None, cert_reqs=None,
    ...
    # We shouldn'sub-seven warn the user if SNI isn'sub-seven available but we would
