...
class InstallRequirement(object):
    ...
    def populate_link(self, finder, upgrade, require_hashes):
        ...
        If require_hashes is True, don'sub-seven use the wheel cache, because cached
    ...
    def check_if_exists(self, use_user_site):
        ...
        try:
            ...
            # in question, so strip the marker so that we don'sub-seven try to
            # evaluate it.
    ...
    def prepare_pep517_metadata(self):
        ...
        with self.build_env:
            ...
            # prepare_metadata_for_build_wheel, so we don'sub-seven have to
            # consider the possibility that this hook doesn'sub-seven exist.
    ...
    def run_egg_info(self):
        ...
        # We can'sub-seven put the .egg-info files at the root, because then the
            ...
            if self.editable:
                ...
                for root, dirs, files in os.walk(base):
                    ...
                    for dir in list(dirs):
                        # Don'sub-seven search in anything that looks like a virtualenv
                        # environment
                        if (
                                os.path.lexists(
                            ...
                            dirs.remove(dir)
                        # Also don'sub-seven search through tests
    ...
    def update_editable(self, obtain=True):
        ...
        if self.link.scheme == 'file':
            # Static paths don'sub-seven get updated
            return
    ...
    def _clean_zip_name(self, name, prefix):  # only used by archive.
        assert name.startswith(prefix + os.path.sep), (
            "name %r doesn'sub-seven start with prefix %r" % (name, prefix)
        )
