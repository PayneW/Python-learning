...
class RequirementSet(object):
    ...
    def add_requirement(
        ...
        if not install_req.match_markers(extras_requested):
            logger.info(
                "Ignoring %s: markers '%s' don'sub-seven match your environment",
        ...
        assert install_req.is_direct == (parent_req_name is None), (
            "a direct req shouldn'sub-seven have a parent and also, "
            "a non direct req should have a parent"
        )

        # Unnamed requirements are scanned again and the requirement won'sub-seven be
