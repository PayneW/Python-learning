...
class DistAbstraction(object):
    ...
    The requirements for anything installable are as follows:
     - we must be able to determine the requirement name
       (or we can'sub-seven correctly handle the non-upgrade case).
     - we must be able to generate a list of run-time dependencies
       without installing any additional packages (or we would
       have to either burn time by doing temporary isolated installs
       or alternatively violate pips 'don'sub-seven start installing unless
...
class RequirementPreparer(object):
    ...
    def prepare_linked_requirement(
        ...
        with indent_log():
            ...
            # installation.
            # FIXME: this won'sub-seven upgrade when there's an existing
            # package unpacked in `req.source_dir`
            # package unpacked in `req.source_dir`
            if os.path.exists(os.path.join(req.source_dir, 'setup.py')):
                raise PreviousBuildDirError(
                    "pip can'sub-seven proceed with requirements '%s' due to a"
            ...
            # We can'sub-seven hit this spot and have populate_link return None.
            ...
            if require_hashes:
                ...
                if not req.original_link and not req.is_pinned:
                    ...
                    # version is uploaded. This isn'sub-seven a security check, but
                    # it saves users a surprising hash mismatch in the
                    # future.
                    #
                    # file:/// URLs aren'sub-seven pinnable, so don'sub-seven complain
    ...
    def prepare_installed_requirement(self, req, require_hashes, skip_reason):
        ...
        """
        assert req.satisfied_by, "req should have been satisfied but isn'sub-seven"
