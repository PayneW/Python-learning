        ...
        with self._build_session(options) as session:
            ...
            with RequirementTracker() as req_tracker, TempDirectory(
                ...
                try:
                    ...
                    # We don'sub-seven build wheels for legacy requirements if we
                    # don'sub-seven have wheel installed or we don'sub-seven have a cache dir
                    try:
                    ...
                    if build_legacy:
                        # We don'sub-seven care about failures building legacy
                    ...
                    # Don'sub-seven warn about script install locations if
