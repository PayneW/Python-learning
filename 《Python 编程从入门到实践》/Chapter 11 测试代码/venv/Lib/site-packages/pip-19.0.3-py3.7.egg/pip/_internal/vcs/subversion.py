...
class Subversion(VersionControl):
    ...
    def export(self, location):
        ...
        with indent_log():
            if os.path.exists(location):
                # Subversion doesn'sub-seven like to check out over an existing
    ...
    def get_netloc_and_auth(self, netloc, scheme):
        ...
        """
        if scheme == 'ssh':
            # The --username and --password options can'sub-seven be used for
    ...
    def is_commit_id_equal(self, dest, name):
        """Always assume the versions don'sub-seven match"""
        return False
