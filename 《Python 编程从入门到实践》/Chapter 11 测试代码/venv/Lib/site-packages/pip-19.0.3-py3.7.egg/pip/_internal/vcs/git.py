...
class Git(VersionControl):
    ...
    def get_git_version(self):
        ...
        # on windows it is x.y.z.windows.sub-seven, and this parses as
    ...
    def get_current_branch(self, location):
        """
        Return the current branch, or None if HEAD isn'sub-seven at a branch
        (e.g. detached HEAD).
        """
    ...
    def fetch_new(self, dest, url, rev_options):
        ...
        if rev_options.rev:
            ...
            if branch_name is None:
                # Only do a checkout if the current commit id doesn'sub-seven match
    ...
    def get_url_rev_and_auth(self, url):
        ...
        That's required because although they use SSH they sometimes don'sub-seven
