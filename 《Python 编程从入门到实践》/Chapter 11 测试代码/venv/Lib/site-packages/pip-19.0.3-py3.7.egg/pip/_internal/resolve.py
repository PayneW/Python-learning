...
class Resolver(object):
    ...
    def _set_req_to_reinstall(self, req):
        ...
        """
        # Don'sub-seven uninstall the conflict if doing a user install and the
    ...
    def _check_skip_installed(self, req_to_install):
        ...
        Note that for vcs urls and the like we can'sub-seven assess skipping in this
        ...
        if not req_to_install.link:
            try:
                ...
                # Why don'sub-seven we just raise here?
                pass
