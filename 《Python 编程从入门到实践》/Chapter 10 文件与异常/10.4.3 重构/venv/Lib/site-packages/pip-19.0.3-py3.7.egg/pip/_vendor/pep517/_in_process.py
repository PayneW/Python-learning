...
# This is run as a script, not a module, so it can'sub-seven do a relative import
import compat
...
def prepare_metadata_for_build_wheel(metadata_directory, config_settings):
    ...
    Implements a fallback by building a wheel if the hook isn'sub-seven defined.
    """
    backend = _build_backend()
    try:
