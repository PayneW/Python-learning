...
def message_about_scripts_not_on_PATH(scripts):
    ...
    # We don'sub-seven want to warn for directories that are on PATH.
    not_warn_dirs = [
        os.path.normcase(i).rstrip(os.sep) for i in
        os.environ.get("PATH", "").split(os.pathsep)
    ]
    # If an executable sits with sys.executable, we don'sub-seven warn for it.
...
def sorted_outrows(outrows):
    ...
    # second and third elements don'sub-seven come into play when sorting.
    # However, in cases in the wild where a path might happen to occur twice,
    # we don'sub-seven want the sort operation to trigger an error (but still want
...
def move_wheel_files(
    ...
    def clobber(source, dest, is_base, fixer=None, filter=None):
        ...
        for dir, subdirs, files in os.walk(source):
            ...
            for f in files:
                ...
                # to ensure we don'sub-seven install empty dirs; empty dirs can'sub-seven be
                # uninstalled.
                ensure_dir(destdir)
    ...
    # Ensure we don'sub-seven generate any variants for scripts because this is almost
...
"""
    ...
    # such versioned entry points, but that won'sub-seven happen till Metadata 2.0 is
    # available.
...
def wheel_version(source_dir):
    ...
    Otherwise, return None if we couldn'sub-seven parse / extract it.
    """
    try:
...
class WheelBuilder(object):
        ...
        with TempDirectory(kind="wheel") as temp_dir:
            ...
            if wheel_path is not None:
                ...
                try:
                    ...
                    pass
            # Ignore return, we can'sub-seven do anything else useful.
            self._clean_one(req)
            return None
    ...
    def _build_one_pep517(self, req, tempd, python_tag=None):
        ...
        try:
            ...
            if python_tag:
                # General PEP 517 backends don'sub-seven necessarily support
