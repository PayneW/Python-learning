...
def _best_version(fields):
    ...
    if not is_1_1 and not is_1_2 and not is_2_1 and not is_2_0:
        # we couldn'sub-seven find any specific marker
...
#    dependencies = property(_get_dependencies, _set_dependencies)
    ...
    def update(self, other=None, **kwargs):
        ...
        Keys that don'sub-seven match a metadata field or that have an empty value are
        dropped.
        """
        def _set(key, value):
    ...
    def add_requirements(self, requirements):
        if self['Metadata-Version'] == '1.1':
            # we can'sub-seven have 1.1 metadata *and* Setuptools requires
